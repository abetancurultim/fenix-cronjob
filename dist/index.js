...
node_schedule_1.default.scheduleJob("30 12 * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    yield executeInHoursJobWithValidation("ESCENARIO 1: Job de medio día (12:30 PM Colombia)");
}));
...
node_schedule_1.default.scheduleJob("30 17 * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    yield executeInHoursJobWithValidation("ESCENARIO 1: Job de tarde (5:30 PM Colombia)");
}));
...
console.log("📅 ESCENARIO 1: Conversaciones sin respuesta - 12:30 PM y 5:30 PM hora Colombia");
